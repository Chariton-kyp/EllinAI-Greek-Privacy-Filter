...
EASY: list[dict] = [
    ...
    _build(
        "Το development API key είναι zx-ABC123XYZ456DEF789GHI000, μην το κοινοποιείς.",
        [("secret", "zx-ABC123XYZ456DEF789GHI000")],
        "easy", "code_comments",
    ),
]
...
MEDIUM: list[dict] = [
    ...
    _build(
        ...
        "zx-prod-9A8B7C6D5E4F3G2H1I0J και δεν πρέπει να ανέβει στο git.",
        [("secret", "zx-prod-9A8B7C6D5E4F3G2H1I0J")],
...
HARD: list[dict] = [
    ...
    _build(
        "# TODO: κώδικας = zx-dev-ABCDEF123456; contact dev@mail.gr ή "
        "6944112233 αν χρειάζεται rotation του secret.",
        [
            ("secret", "zx-dev-ABCDEF123456"),
