...
the Greek Privacy Filter fine-tune, (2) the non-commercial public release strategy for
...
| Fine-tuned model weights (`artifacts/model/…`) | Non-commercial (LICENSE-NC) **or** a paid commercial license on request | Full commercial use (you are the copyright holder) |
...
non-commercial public release model.

**Important:** The legal validity of this non-commercial public release model depends on
