...
Pseudo-labelled corpus (Apache 2.0 derivative; data only, not shipped)
       │
       ├─► Lite     openai/privacy-filter 1.4B   (NC public release)
       ├─► Mini     google/gemma-4-E2B-it        (NC public release)
       ├─► Pro      google/gemma-4-E4B-it        (NC public release)
       ├─► Max      Qwen/Qwen3-4B-Instruct       (NC public release)
       └─► Ultra    google/gemma-4-31B-it teacher itself  (NC public release)
```
